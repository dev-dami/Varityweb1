...
export function SessionNavBar() {
  ...
  const userName = session?.user.name || "Andrew Luo";
  const userEmail = session?.user.email || "andrew@usehindsight.com";
  const userFallback = (session?.user.name?.[0] || session?.user.email?.[0] || "A").toUpperCase();
  const orgName = session ? `${session.user.name || "My"}'s Workspace` : "Organization";
                  ...
                  <DropdownMenuTrigger className="w-full" asChild>
                    ...
                    >
                      <Avatar className='rounded size-4'>
                        <AvatarFallback>{orgName.substring(0, 1).toUpperCase()}</AvatarFallback>
                      </Avatar>
                      <motion.li
                        variants={variants}
                ...
                <ScrollArea className="h-16 grow p-2">
                  <div className={cn("flex w-full flex-col gap-1")}>
                    ...
                    >
                      ...
                      <motion.li variants={variants} className="list-none">
                        {!isCollapsed && (
                          <p className="ml-2 text-sm font-medium">Sites</p>
                        )}
                      </motion.li>
                    </Link>
                    <Link
                    ...
                    <Link
                      ...
                      className={cn(
                        ...
                        activeTab === "chat" && "bg-muted text-blue-600",
                      )}
                    >
                    ...
                    <Link
                      ...
                      className={cn(
                        "flex h-8 w-full flex-row items-center rounded-md px-2 py-1.5   transition hover:bg-muted hover:text-primary",
                        activeTab === "deals" && "bg-muted text-blue-600",
                      )}
                    >
              ...
              <div className="flex flex-col p-2">
                <Link
                  ...
                  className={cn(
                    ...
                    activeTab === "settings" && "bg-muted text-blue-600",
                  )}
                >
                    ...
                    <DropdownMenuTrigger className="w-full" asChild>
                      <div className="flex h-8 w-full flex-row items-center gap-2 rounded-md px-2 py-1.5  transition hover:bg-muted hover:text-primary cursor-pointer">
                        ...
                        >
                          {!isCollapsed && (
                            <>
                              <p className="text-sm font-medium truncate max-w-[100px]">{userName}</p>
